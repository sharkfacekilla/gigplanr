        ...
        <div className="flex items-center justify-center min-h-screen p-6">
          <div className="flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-6 bg-green rounded-lg shadow-lg p-6 md:p-8">
            <div className="md:ms-3 lg:ms-4 grid grid-cols-2 gap-4 w-full md:w-1/2">
              <div className="transform rotate-3d drop-shadow-lg flex items-center justify-center bg-transparent" style={{ width: '100%', maxWidth: 200, height: 'auto' }}>
                <img src="img/americanIdiot.png" alt="Album 1" className="w-full h-full object-cover rounded-md" />
              </div>
              <div className="transform rotate-3d drop-shadow-lg flex items-center justify-center bg-transparent" style={{ width: '100%', maxWidth: 200, height: 'auto' }}>
                <img src="img/americanIdiot.png" alt="Album 2" className="w-full h-full object-cover rounded-md" />
              </div>
              <div className="transform rotate-3d drop-shadow-lg flex items-center justify-center bg-transparent" style={{ width: '100%', maxWidth: 200, height: 'auto' }}>
                <img src="img/americanIdiot.png" alt="Album 3" className="w-full h-full object-cover rounded-md" />
              </div>
              <div className="transform rotate-3d drop-shadow-lg flex items-center justify-center bg-transparent" style={{ width: '100%', maxWidth: 200, height: 'auto' }}>
                <img src="img/americanIdiot.png" alt="Album 4" className="w-full h-full object-cover rounded-md" />
              </div>
            </div>

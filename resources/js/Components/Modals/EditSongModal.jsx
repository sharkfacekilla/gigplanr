...
export default function NewSongModal({ show, onClose, song }) {
    ...
    const onSubmit = (e) => {
        ...
        formData.append('album_track_number', data.album_track_number);
                    ...
                    <div className="grid grid-cols-2 gap-4 my-2">
                        <div className="flex flex-wrap items-center my-auto">
                            <div className="w-full">
                                ...
                                <input required id="title" type="text" value={data.title} name="title" isFocused={true} onChange={(e) => setData("title", e.target.value)} className="block py-2.5 px-0 w-full text-sm text-dark-black bg-transparent border-0 border-b border-dark-black/20 appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" />
                            </div>
                            <div className="w-full">
                                <InputLabel htmlFor="album" className="text-nowrap text-xs text-dark-black mb-1 ms-1 mt-6" value="Album Title" />
                                <input id="album" type="text" value={data.album} name="album" onChange={(e) => setData("album", e.target.value)} className="block py-2.5 px-0 w-full text-sm text-dark-black bg-transparent border-0 border-b border-dark-black/20 appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" />
                            </div>
                            <div className="w-full">
                                <InputLabel htmlFor="bpm" className="text-nowrap text-xs text-dark-black mb-1 ms-1 mt-6" value="BPM" />
                                <input placeholder="N/A" id="bpm" type="number" name="bpm" value={data.bpm} onChange={(e) => setData("bpm", e.target.value)} className="block py-2.5 px-0 w-full text-sm text-dark-black bg-transparent border-0 border-b border-dark-black/20 appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" />
                            </div>
                            <div className="w-full">
                            ...
                            <div className="w-full">
                                ...
                                <input id="album_track_number" value={data.album_track_number} type="number" name="album_track_number" onChange={(e) => setData("album_track_number", e.target.value)} className="block py-2.5 px-0 w-full text-sm text-dark-black bg-transparent border-0 border-b border-dark-black/20 appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" />
                            </div>
                        </div>
                        <div className="flex flex-wrap items-center my-auto">
                            ...
                            <div className="w-full">
                                ...
                                <input placeholder="N/A" id="key" type="text" name="key" value={data.key} onChange={(e) => setData("key", e.target.value)} className="block py-2.5 px-0 w-full text-sm text-dark-black bg-transparent border-0 border-b border-dark-black/20 appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" />
                            </div>
                            <div className="w-full">
                                <InputLabel htmlFor="tuning" className="text-nowrap text-xs text-dark-black mb-1 ms-1 mt-6" value="Tuning" />
                                <input placeholder="N/A" id="tuning" type="text" name="tuning" value={data.tuning} onChange={(e) => setData("tuning", e.target.value)} className="block py-2.5 px-0 w-full text-sm text-dark-black bg-transparent border-0 border-b border-dark-black/20 appearance-none focus:outline-none focus:ring-0 focus:border-teal peer" />
                            </div>
